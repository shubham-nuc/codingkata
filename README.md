Coding Kata
Please timebox 3-4 hours of your time to run a short kata and send us the resulting code. We are not expecting you to complete the exercise in the timebox, so think about what you want to convey to us in your code and focus on that.
Kata details
